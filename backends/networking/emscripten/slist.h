...
#ifndef BACKENDS_NETWORKING_EMSCRIPTEN_SLIST_H
#define BACKENDS_NETWORKING_EMSCRIPTEN_SLIST_H
#include <stdlib.h>
#include <string.h>
 ...
 * released.
 */
inline struct curl_slist *Curl_slist_append_nodup(struct curl_slist *list, char *data)
{
