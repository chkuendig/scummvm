...
#if defined(USE_FORCED_GLES2) || defined(USE_GLES2)
...
namespace hpl
{
	...
	{
	public:
		cAndroidTexture(const tString &asName, Graphics::PixelFormat *apPxlFmt, iLowLevelGraphics *apLowLevelGraphics,
...
#endif // USE_FORCED_GLES2 || USE_GLES2
